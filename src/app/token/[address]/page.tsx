      ...
      {!isOnDex && (
        <div className="card">
          ...
          <div className="flex justify-between text-[10px] text-synth-muted mt-2">
            <span>{metricPrefix}{t('token.reserve')}: {token.reserve?.toFixed(4)} {nativeSymbol}</span>
            <span>{metricPrefix}{t('token.supply')}: {(token.circulatingSupply / 1e6).toFixed(1)}M / 1B</span>
          </div>
        </div>
      )}
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <span className="text-lg font-bold text-synth-green">{taxRevenue.totalFeesNative.toFixed(4)} {nativeSymbol}</span>
            ...
            <div className="text-center">
              ...
              <span className="text-lg font-bold text-synth-cyan">{taxRevenue.claimedNative.toFixed(4)} {nativeSymbol}</span>
            ...
            <div className="text-center">
              ...
              <span className="text-lg font-bold text-synth-green">{taxRevenue.pendingNative.toFixed(4)} {nativeSymbol}</span>
        ...
        <div className="card space-y-3">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-synth-text">{chainLabel}</span>
            </div>
            <div className="flex justify-between">
