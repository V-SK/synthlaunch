const i18n = {
  en: {
    ...
    "proof.title": "Live X Layer state",
    "proof.codeLength": "Hook code length",
    "proof.currentFee": "Current fee",
    "proof.normalFee": "Normal fee",
    "proof.launchActive": "Launch active",
    "proof.poolInitialized": "Pool initialized",
    "proof.eventsTitle": "Proof events",
    "proof.eventsCopy": "Two swaps in block 61091448 emitted `AgentXPUpdated`, moving XP from 0 to 10 and then 20. This gives the judges a simple, verifiable before/after proof path.",
  ...
  zh: {
    ...
    "proof.title": "X Layer 实时状态",
    "proof.codeLength": "Hook 代码长度",
    "proof.currentFee": "当前费率",
    "proof.normalFee": "常规费率",
    "proof.launchActive": "发射保护中",
    "proof.poolInitialized": "池已初始化",
    "proof.eventsTitle": "证明事件",
    "proof.eventsCopy": "区块 61091448 中两笔 swap 触发了 `AgentXPUpdated`，XP 从 0 到 10 再到 20。评委可以直接复核这个前后状态变化。",
